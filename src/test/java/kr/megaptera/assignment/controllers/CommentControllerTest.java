...
class CommentControllerTest {
  ...
  void list() throws Exception {
    ...
    given(getCommentsService.getCommentList(postId))
        .willReturn(List.of(
  ...
  void create() throws Exception {
    ...
    CommentCreateRequestDto request = new CommentCreateRequestDto(postId,"작성자","내용");
    ...
    verify(createCommentService).createComment(any(CommentCreateRequestDto.class));
  }
...
//
//
//    CommentUpdateRequestDto request = new CommentUpdateRequestDto("test");
//    String json = objectMapper.writeValueAsString(request);
//
//
...
////        .andExpect(status().isOk());
//
//    verify(updateCommentService).update(
//        eq(commentId),
